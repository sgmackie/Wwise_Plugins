...
BEGIN_MESSAGE_MAP(WavetableApp, CWinApp)
END_MESSAGE_MAP()

WavetableApp::WavetableApp()
{
}

WavetableApp theApp;

BOOL WavetableApp::InitInstance()
{
...
{
    if (in_companyID == WavetableConfig::CompanyID && in_pluginID == WavetableConfig::PluginID)
