...
BEGIN_MESSAGE_MAP(TransientApp, CWinApp)
END_MESSAGE_MAP()

TransientApp::TransientApp()
{
}

TransientApp theApp;

BOOL TransientApp::InitInstance()
{
...
{
    if (in_companyID == TransientConfig::CompanyID && in_pluginID == TransientConfig::PluginID)
        return new TransientPlugin;
